...
public class ThirdPersonCameraController : MonoBehaviour
{
	...
	public string[] layersToIgnoreCulling;
	...
	private Vector3 CastRayFromPlayer (Vector3 cameraPosition)
	{
		...
		if (Physics.Raycast (lookAtPosition, cameraDirection.normalized, out hit, maxDistanceToPlayer, ~LayerMask.GetMask (layersToIgnoreCulling))) {
